...
def build_reviewer_prompt(task: Task, memory_context: str) -> str:
    ...
    parts.extend([
        "## Instructions",
        "",
        "1. **Examine the workspace** at /workspace to see the"
        " current state of the code.",
        "",
        "2. **Run `git diff HEAD~1`** to see exactly what the dev"
        " agent changed.",
        "",
        ...
        "   - **Style**: Does the code follow the project's existing"
        " patterns and conventions?",
        "   - **Performance**: Are there any obvious performance"
        " issues?",
        "",
        ...
        "",
        "## Guidelines",
        "- Use verdict `\"approve\"` if the code is acceptable"
        " (minor style issues are OK).",
